...
def control(prevDistance, img_width, img_height, cx, cy, m):   # 一つ前の行動の進んだ距離, 重心x座標, 重心y座標, 画像の幅, 画像の高さ, 傾き
    ...
    # fx = 0.005784 * np.exp(0.013606 * (img_height - cy)) + 0.346111
    # fx = 0.006689 * np.exp(0.013240 * (img_height - cy)) + 0.359777
    fx = 0.006912 * np.exp(0.013168 * (img_height - cy)) + 0.355108
