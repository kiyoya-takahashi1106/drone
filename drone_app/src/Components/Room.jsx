  ...
  return (
    <div style={{ height: '50px', width: '800px', margin: '5px 0px 0px 0px', display: 'flex', alignItems: 'center', border: '2px solid black', fontFamily: '"Abel", sans-serif' }}>
        ...
        <Link to={{ pathname: "/home/setting/"+roomInformation.N+"/"+roomInformation.M+"/"+roomInformation.height+"/"+roomInformation.width }}>
            <button style={{ height: '48px', width: '50px', backgroundImage: `url(${startIcon})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', border: 'none', cursor: 'pointer' }}></button>
            <button style={{ height: '48px', width: '50px', backgroundImage: `url(${deleteIcon})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', border: 'none', cursor: 'pointer' }}></button>
        </Link>
    </div>
  )
}
